...
image = nb.load('D:/Documents/FastSurfer/DUILIO/NORAH_code/r_ADNI_002left.nii')
image = np.array(image.get_fdata())

imagepair = nb.load('D:/Documents/FastSurfer/DUILIO/NORAH_code/r_ADNI_002right.nii')
...
model = torch.load('D:/Documents/FastSurfer/DUILIO/NORAH_code/thalamus.pt')
model.eval()
